...
class CheckoutCreditCard < Test::Unit::TestCase
  ...
  ##############################################################
  #
  # Test Cases for Monthly Prime Subscriptions
  #
  ##############################################################
  ...
  ##############################################################
  #
  # Test Cases for Annual Prime Subscriptions
  #
  ##############################################################  
  def test_checkout_annual
    purchase_steps("Visa",        "IGN Prime Annual")
    purchase_steps("Amex",        "IGN Prime Annual")
    purchase_steps("Mastercard",  "IGN Prime Annual")
    purchase_steps("Discover",   "IGN Prime Monthly")    
  end

  ##############################################################
  #
  # Test Cases for Biannual Prime Subscriptions
  #
  ##############################################################
  def test_checkout_biannual
    purchase_steps("Visa",        "IGN Prime Biannual")
    purchase_steps("Amex",        "IGN Prime Biannual")
    purchase_steps("Mastercard",  "IGN Prime Biannual")
    purchase_steps("Discover",   "IGN Prime Monthly")    
  end  
