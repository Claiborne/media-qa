...
module GlobalHeaderMod

  def global_header(descript)
	...
	begin
        assert @selenium.is_element_present("css=li#navItem-cheats a[href=http://cheats.ign.com]"), "Unable to verify Global header 'Cheats' nav link working on #{descript}"
    rescue Test::Unit::AssertionFailedError
        @verification_errors << $!
    end
	begin
