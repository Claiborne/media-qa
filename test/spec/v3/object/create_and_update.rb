...
describe "V3 Object API -- Create Game", :stg => true do
  ...
  before(:all) do
    ...
    @url = "http://#{@config.stg['baseurl']}/games?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Create Company", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/companies?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin 
...
describe "V3 Object API -- Create Feature", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/features?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin 
...
describe "V3 Object API -- Create Genre", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/genres?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Create Hardware", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/hardware?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin 
...
describe "V3 Object API -- Create Market", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/markets?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin 
...
describe "V3 Object API -- Create Movie", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/movies?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Create Volume", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/volumes?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Create Book", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/books?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Create Person", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/people?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Create Character", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/characters?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Create RoleType", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/roleTypes?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Create Show", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/shows?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Create Season", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/seasons?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Create Episode", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/episodes?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Create Role", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/roles?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Create Release", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/releases?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin 
...
describe "V3 Object API -- Update Game", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/games/#{UpdateHelperVars.return_game_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin 
...
describe "V3 Object API -- Update Company", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/companies/#{UpdateHelperVars.return_company_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin 
...
describe "V3 Object API -- Update Feature", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/features/#{UpdateHelperVars.return_feature_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin 
...
describe "V3 Object API -- Update Genre", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/genres/#{UpdateHelperVars.return_genre_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin 
...
describe "V3 Object API -- Update Second Genre", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/genres/#{UpdateHelperVars.return_genre2_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Update Hardware", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/hardware/#{UpdateHelperVars.return_hardware_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin 
...
describe "V3 Object API -- Update Market", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/markets/#{UpdateHelperVars.return_market_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin 
...
describe "V3 Object API -- Update Movie", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/movies/#{UpdateHelperVars.return_movie_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Update Volume", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/volumes/#{UpdateHelperVars.return_volume_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Update Book", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/books/#{UpdateHelperVars.return_book_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
      vol1 = JSON.parse(RestClient.get("http://#{@config.stg['baseurl']}/volumes/slug/100-bullets?fresh=true").body)['volumeId']
      vol2 = JSON.parse(RestClient.get("http://#{@config.stg['baseurl']}/volumes/slug/batman-the-return?fresh=true").body)['volumeId']
...
describe "V3 Object API -- Update Person", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/people/#{UpdateHelperVars.return_person_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Update Character", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/characters/#{UpdateHelperVars.return_character_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Update RoleType", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/roleTypes/#{UpdateHelperVars.return_roletype_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Update Show", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/shows/#{UpdateHelperVars.return_show_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Check Nested Updates Reflect in Episode", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/episodes/#{UpdateHelperVars.return_episode_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
...
describe "V3 Object API -- Check Nested Updates Reflect in Book", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/books/#{UpdateHelperVars.return_book_id}?fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Check Nested Updates Reflect in Role", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/roles/#{UpdateHelperVars.return_role_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Check Nested Updates Reflect in Release", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/releases/#{UpdateHelperVars.return_release_id}?oauth_token=#{UpdateHelperVars.return_token}&fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Check Nested Updates Reflect in Season", :stg => true do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.stg['baseurl']}/seasons/#{UpdateHelperVars.return_season_id}?fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Clean Up: Delete Objects", :stg => true do
  ...
  expect {RestClient.get "http://#{@config.stg['baseurl']}/#{obj[val]}/#{id}?fresh=true"}.to raise_error(RestClient::ResourceNotFound)
