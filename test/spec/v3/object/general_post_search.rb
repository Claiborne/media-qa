...
describe "V3 Object API -- Post Search for Published 360 Releases: #{release_search_smoke}", :stg => true do
...
describe "V3 Object API -- Post Search for Reviewed Releases: #{reviewed_games}", :stg => true do
...
{mass_effect_3_releases_by_game_id=>'GameId',mass_effect_3_releases_by_game_legacyid=>'LegacyId',mass_effect_3_releases_by_game_slug=>'Game Slug'}.each do |request_body,description|
  describe "V3 Object API -- Post Search for Releases by #{description} using: #{request_body}", :stg => true do
...
describe "V3 Object API -- Post Search for Bioware Releases By Dev Name: #{bioware_games_by_dev_name}", :stg => true do
...
describe "V3 Object API -- Post Search for Bioware Releases By Dev legacyId: #{bioware_games_by_dev_legacyid}", :stg => true do
...
describe "V3 Object API -- Post Search for Releases Released Boolean: #{release_by_is_released(is_released)}", :stg => true do
...
describe "V3 Object API -- Post Search - Test Pagination Using: #{release_pagination(11,0)}", :stg => true do
