...
describe "V3 Object API -- Releases Smoke Tests -- /ping" do
  ...
  before(:all) do
    ...
    @url = "http://#{@config.options['baseurl']}/ping?fresh=true"
    begin
...
describe "V3 Object API -- Releases Smoke Tests -- /releases?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/releases?count=200&fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Releases Smoke Tests -- /releases/legacyId/110694" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/releases/legacyId/110694?fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Releases Smoke Tests -- /releases/#{ObjectIds.me3_uk_release_id}" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/releases/#{ObjectIds.me3_uk_release_id}?fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Games Smoke Tests -- /games?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/games?count=200&fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Games Smoke Tests -- /games#{call}" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/games#{call}?fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Companies Smoke Tests -- /companies?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/companies?count=200&fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Companies Smoke Tests -- /companies?query=art&count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/companies?query=art&count=200&fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Companies Smoke Tests -- /companies#{call}" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/companies#{call}?fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Features Smoke Tests -- /features?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/features?count=200&fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Features Smoke Tests -- /features#{call}" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/features#{call}?fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Genre Smoke Tests -- /genres?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/genres?count=200&fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Genre Smoke Tests -- /genres#{call}" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/genres#{call}?fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Hardware Smoke Tests -- /hardware?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/hardware?count=200&fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Hardware Smoke Tests -- /hardware#{call}" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/hardware#{call}?fresh=true"
    begin 
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Movies Smoke Tests -- /movies?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/movies?count=200&fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
["/#{ObjectIds.movie_id}","/slug/the-dark-knight"].each do |call|
  describe "V3 Object API -- Movies Smoke Tests -- /movies#{call}" do
    ...
    before(:all) do
      PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
      @config = PathConfig.new
      @url = "http://#{@config.options['baseurl']}/movies#{call}?fresh=true"
      begin
        @response = RestClient.get @url
      rescue => e
        raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Books Smoke Tests -- /books?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/books?count=200&fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
["/#{ObjectIds.book_id}","/slug/batman-the-dark-knight-2011-11"].each do |call|
  describe "V3 Object API -- Books Smoke Tests -- /books#{call}" do
    ...
    before(:all) do
      PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
      @config = PathConfig.new
      @url = "http://#{@config.options['baseurl']}/books#{call}?fresh=true"
      begin
        @response = RestClient.get @url
      rescue => e
        raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Volumes Smoke Tests -- /volumes?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/volumes?count=200&fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
["/#{ObjectIds.volume_id}","/slug/batman-the-dark-knight-2011"].each do |call|
  describe "V3 Object API -- Volume Smoke Tests -- /volumes#{call}" do
    ...
    before(:all) do
      PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
      @config = PathConfig.new
      @url = "http://#{@config.options['baseurl']}/volumes#{call}?fresh=true"
      begin
        @response = RestClient.get @url
      rescue => e
        raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- People Smoke Tests -- /people?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/people?count=200&fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
["/#{ObjectIds.person_id}","/slug/christian-bale"].each do |call|
  describe "V3 Object API -- People Smoke Tests -- /people#{call}" do
    ...
    before(:all) do
      PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
      @config = PathConfig.new
      @url = "http://#{@config.options['baseurl']}/people#{call}?fresh=true"
      begin
        @response = RestClient.get @url
      rescue => e
        raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Character Smoke Tests -- /characters?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/characters?count=200&fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
["/#{ObjectIds.character_id}","/slug/batman"].each do |call|
  describe "V3 Object API -- Character Smoke Tests -- /characters#{call}" do
    ...
    before(:all) do
      PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
      @config = PathConfig.new
      @url = "http://#{@config.options['baseurl']}/characters#{call}?fresh=true"
      begin
        @response = RestClient.get @url
      rescue => e
        raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- RoleType Smoke Tests -- /roleTypes?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/roleTypes?count=200&fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
["/#{ObjectIds.roletype_id}","/slug/actor"].each do |call|
  describe "V3 Object API -- RoleTypes Smoke Tests -- /roleTypes#{call}" do
    ...
    before(:all) do
      PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
      @config = PathConfig.new
      @url = "http://#{@config.options['baseurl']}/roleTypes#{call}?fresh=true"
      begin
        @response = RestClient.get @url
      rescue => e
        raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Role Smoke Tests -- /roles?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/roles?count=200&fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
["/#{ObjectIds.role_id}","/legacyId/940319"].each do |call|
  describe "V3 Object API -- Role Smoke Tests -- /roles#{call}" do
    ...
    before(:all) do
      PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
      @config = PathConfig.new
      @url = "http://#{@config.options['baseurl']}/roles#{call}?fresh=true"
      begin
        @response = RestClient.get @url
      rescue => e
        raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Shows Smoke Tests -- /shows?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/shows?count=200&fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
["/#{ObjectIds.show_id}","/slug/batman-the-animated-series"].each do |call|
  describe "V3 Object API -- Shows Smoke Tests -- /shows#{call}" do
    ...
    before(:all) do
      PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
      @config = PathConfig.new
      @url = "http://#{@config.options['baseurl']}/shows#{call}?fresh=true"
      begin
        @response = RestClient.get @url
      rescue => e
        raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Seasons Smoke Tests -- /seasons?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/seasons?count=200&fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
["/#{ObjectIds.season_id}","/slug/batman-the-animated-series-season-1"].each do |call|
  describe "V3 Object API -- Seasons Smoke Tests -- /seasons#{call}" do
    ...
    before(:all) do
      PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
      @config = PathConfig.new
      @url = "http://#{@config.options['baseurl']}/seasons#{call}?fresh=true"
      begin
        @response = RestClient.get @url
      rescue => e
        raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Episodes Smoke Tests -- /episodes?count=200" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/episodes?count=200&fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
...
["/#{ObjectIds.episode_id}","/slug/dreams-in-darkness"].each do |call|
  describe "V3 Object API -- Episodes Smoke Tests -- /episodes#{call}" do
    ...
    before(:all) do
      PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
      @config = PathConfig.new
      @url = "http://#{@config.options['baseurl']}/episodes#{call}?fresh=true"
      begin
        @response = RestClient.get @url
      rescue => e
        raise Exception.new(e.message+" "+@url)
...
describe "V3 Object API -- Episodes Smoke Tests -- /episodes/show/#{ObjectIds.show_id}" do
  ...
  before(:all) do
    PathConfig.config_path = File.dirname(__FILE__) + "/../../../config/v3_object.yml"
    @config = PathConfig.new
    @url = "http://#{@config.options['baseurl']}/episodes/show/#{ObjectIds.show_id}?fresh=true"
    begin
      @response = RestClient.get @url
    rescue => e
      raise Exception.new(e.message+" "+@url)
