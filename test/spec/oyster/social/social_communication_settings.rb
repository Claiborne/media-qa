...
describe "social authentication" do
  ...
  it "should write on someone's wall that I am not follow and has privacy settings turned off" do
  ...
  it "should no be able to write on someone's wall that I am not following and has privacy settings turned on" do
  ...
  it "should be able to write on someone's wall that I am following and has privacy settings turned on" do
